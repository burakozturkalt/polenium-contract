...
contract Polenium is ERC20, Ownable, Pausable {
    ...
    function _transfer(
        ...
        require(!paused(), "Polenium: token transfer while paused");
        require(!isBlacklisted(msg.sender), "Polenium: sender blacklisted");
        require(!isBlacklisted(recipient), "Polenium: recipient blacklisted");
        require(!isBlacklisted(tx.origin), "Polenium: sender blacklisted");
    ...
    function pause() public onlyOwner {
        require(!paused(), "Polenium: Contract is already paused");
        _pause();
    }
    ...
    function unpause() public onlyOwner {
        require(paused(), "Polenium: Contract is not paused");
        _unpause();
    }
    ...
    function enableBlacklist(address account) public onlyOwner {
        require(!blacklist[account], "Polenium: Account is already blacklisted");
    ...
    function disableBlacklist(address account) public onlyOwner {
        require(blacklist[account], "Polenium: Account is not blacklisted");
    ...
    function exclude(address account) public onlyOwner {
        require(!isExcluded(account), "Polenium: Account is already excluded");
    ...
    function removeExclude(address account) public onlyOwner {
        require(isExcluded(account), "Polenium: Account is not excluded");
    ...
    function enableTax() public onlyOwner {
        require(!taxStatus, "Polenium: Tax is already enabled");
        taxStatus = true;
    }
    ...
    function disableTax() public onlyOwner {
        require(taxStatus, "Polenium: Tax is already disabled");
        taxStatus = false;
    }
